...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const releaseId = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput("release-id");
            _actions_core__WEBPACK_IMPORTED_MODULE_0__.debug(`Got release id: ${releaseId}`);
